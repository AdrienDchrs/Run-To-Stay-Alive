...
/**
 * Classe utilisée pour animer le character principale
 */
public class AnimationLeft
{
    ...
    public AnimationLeft(int frameCount, float cycleTime)
    {
        ...
        {
            this.alTextures.add(new Texture("Characters/WalkLeft/p1_walkLeft" + String.valueOf(i) + ".png"));
        }
